...
import { Banknote, Sprout, Truck, PiggyBank, ShoppingCart, Leaf, ArrowRight } from "lucide-react"
...
export function ServicesSection({ services, pacsSlug }: ServicesSectionProps) {
